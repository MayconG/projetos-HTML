...
const player = {
    ...
    mensagem_ciclo: document.querySelector('#mensagem'),
    ...
    mudar_ciclo() {
        if (this.botão_ciclo.innerHTML === 'repeat') {
            ...
            this.mensagem_ciclo.innerHTML = 'Cíclo único'

        } else if (this.botão_ciclo.innerHTML === 'repeat_one') {
            this.botão_ciclo.innerHTML = 'shuffle'
            this.mensagem_ciclo.innerHTML = 'Aleatório'
        } else {
            this.botão_ciclo.innerHTML = 'repeat'
            this.mensagem_ciclo.innerHTML = 'Cíclo da lista'
        }
    },

    avançar() {
        this.currentplay++
        if (this.botão_ciclo.innerText === 'repeat' || this.botão_ciclo.innerText === 'repeat_one') {
        ...
        } else if (this.botão_ciclo.innerText === 'shuffle') {
            this.currentplay = Math.floor(Math.random() * this.audios.length)
            this.update()
            this.audio.play()
            this.play_pause.innerHTML = 'pause'
